<template>
  <el-container style="min-height: 100vh; border: 1px solid #eee">
    ...
    <el-container>
      ...
      <el-main>
        <!-- 分页栏 -->
        <el-breadcrumb separator-class="el-icon-arrow-right" style="padding: 5px 0;margin-bottom: 20px">
          <el-breadcrumb-item :to="{ path: '/' }">首页</el-breadcrumb-item>
          <el-breadcrumb-item>书籍归还</el-breadcrumb-item>
        </el-breadcrumb>
        ...
        <el-table :data="tableData" border stripe>
          ...
          <el-table-column prop="bookID" label="图书编号" width="180">
          </el-table-column>
          <el-table-column prop="borrowDate" label="借出日期" width="200">
          </el-table-column>
          <el-table-column prop="remainDate" label="借出时长" width="200">
          </el-table-column>
          <el-table-column prop="isDelay" label="是否延期" width="100">
          </el-table-column>
          <el-table-column label="操作">
            <template slot-scope="scope">
              <el-button type="success" @click="restore">归还 <i class="el-icon-reading"></i></el-button>
              <el-button type="warning" @click="remain">续借 <i class="el-icon-date"></i></el-button>
            </template>
          </el-table-column>
        </el-table>
